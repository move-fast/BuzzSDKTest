 ...
 */
@interface OMIDBuzztechnoVideoEvents : NSObject
 ...
 * @see OMIDAdSession
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDBuzztechnoAdSession *)session error:(NSError *_Nullable *_Nullable)error;
 ...
 */
- (void)loadedWithVastProperties:(nonnull OMIDBuzztechnoVASTProperties *)vastProperties;

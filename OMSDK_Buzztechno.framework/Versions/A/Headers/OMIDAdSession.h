 ...
 */
@interface OMIDBuzztechnoAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly, nonnull) OMIDBuzztechnoAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(nonnull OMIDBuzztechnoAdSessionConfiguration *)configuration
                              adSessionContext:(nonnull OMIDBuzztechnoAdSessionContext *)context

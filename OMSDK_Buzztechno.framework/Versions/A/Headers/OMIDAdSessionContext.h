 ...
 */
@interface OMIDBuzztechnoAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(nonnull OMIDBuzztechnoPartner *)partner
...
- (nullable instancetype)initWithPartner:(nonnull OMIDBuzztechnoPartner *)partner
                               ...
                               resources:(nonnull NSArray<OMIDBuzztechnoVerificationScriptResource *> *)resources
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
